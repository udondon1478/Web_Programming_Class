    ...
    <div class="container">
        ...
        <div class="form-container">
            <form action="insert_message.php" method="POST">
                ...
                タイトル: <br>
                <input type="text" name="title" class="form-control" size="50"> <br>

                メッセージ: <br>
                <textarea name="message" class="form-control" cols="40" rows="5"></textarea> <br>

                <input class="btn btn-primary" type="submit" value="メッセージの登録"> <br>
            </form>
